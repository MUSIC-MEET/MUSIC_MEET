...
class PopularMusicChartAdapter (val popularMusic:ArrayList<popularSong>, val context: Context)
    : RecyclerView.Adapter<PopularMusicChartAdapter.ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return PopularMusicChartAdapter.ViewHolder(
            LayoutInflater.from(context)
                .inflate(R.layout.activity_main_popular_music, parent, false)
        )
    ...
    class ViewHolder(itemView: View?) : RecyclerView.ViewHolder(itemView!!) {
        ...
        //url 앨범표지 안나옴 찾아볼것
        fun songinfo(itemsonginfo: popularSong, context: Context) {
